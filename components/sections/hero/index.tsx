...
type Props = Pick<ISection, '_id' | 'heading' | 'contentFile' | 'description'>;
...
const Hero = memo(({
  ...
  <section id={_id} className="relative w-full h-[100vh] bg-cover bg-no-repeat bg-center snap-start">
    {contentFile && (
      <video
        autoPlay
        muted
